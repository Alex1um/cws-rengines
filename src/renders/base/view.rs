...
impl View {
  ...
  pub fn get_screen_rect(&self, resolution: &(i32, i32)) -> ((i32, i32), (i32, i32)) { self.screen_rect.get_absolute(resolution) }
  ...
  pub fn set_screen_rect(&mut self, new: Rect) {
    self.screen_rect = new;
  }
}
